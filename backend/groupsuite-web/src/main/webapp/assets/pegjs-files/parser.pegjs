...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c15 = peg$otherExpectation("Single Quote"),
        peg$c16 = "'",
        ...
        peg$c25 = peg$otherExpectation("one reserved word (\"direction\" \"messageType/code\", etc.)"),
        peg$c26 = "direction",
        peg$c27 = peg$literalExpectation("direction", false),
        peg$c28 = "messageType/code",
        peg$c29 = peg$literalExpectation("messageType/code", false),
        peg$c30 = "swiftParameters/requestReference",
        peg$c31 = peg$literalExpectation("swiftParameters/requestReference", false),
        peg$c32 = "senderAddress",
        peg$c33 = peg$literalExpectation("senderAddress", false),
        peg$c34 = "receiverAddress",
        peg$c35 = peg$literalExpectation("receiverAddress", false),
        peg$c36 = function() { 
    ...
    function peg$parseWord() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          s3 = peg$parsePointStart();
          if (s3 === peg$FAILED) {
            s3 = null;
          }
          if (s3 !== peg$FAILED) {
            s4 = peg$parseSingleQuote();
            if (s4 !== peg$FAILED) {
              peg$savedPos = s0;
              s1 = peg$c11();
              s0 = s1;
    ...
    function peg$parseReservedWord() {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          if (input.substr(peg$currPos, 32) === peg$c30) {
            s0 = peg$c30;
            peg$currPos += 32;
          } else {
            s0 = peg$FAILED;
