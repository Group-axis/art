...
trait AMHBackupAssignmentDAO extends DBDriver {

  import driver.api._

  class AMHBackupAssignments(tag: Tag) extends Table[AMHAssignmentEntity](tag, "BAK_AMH_BE_CH_AS_SEL_TAB") with TableAudit {
  ...
  class AMHBackupAssignmentRules(tag: Tag) extends Table[AMHAssignmentRuleEntity](tag, "BAK_AMH_BE_CH_AS_SEL_RU") with TableAudit {
  ...
  val amhBackupAssignments : TableQuery[AMHBackupAssignments] = TableQuery[AMHBackupAssignments]
  val amhBackupAssignmentRules = TableQuery[AMHBackupAssignmentRules]
}

object AMHBackupAssignmentDAO extends AMHBackupAssignmentDAO {
  def apply(driver: JdbcProfile) = AMHBackupAssignmentDAO
}

//trait BackupAssignmentRuleDAO extends DBDriver {
//
//  import driver.api._
//
//  class AMHBackupAssignmentRules(tag: Tag) extends Table[AMHAssignmentRuleEntity](tag, "BAK_AMH_BE_CH_AS_SEL_RU") {
//
//    def code = column[String]("CODE", O.PrimaryKey)
//
//    def sequence = column[Long]("RC_SEQUENCENUMBER", O.PrimaryKey)
...
//    def version = column[String]("VERSION")
//
//    private type AMHAssignmentRuleEntityTupleType = (String, Long, String, Option[String], Option[String], String, String)
//
//    private val amhAssignmentRuleShapedValue = (
//      code,
//      sequence,
...
//      lockCode,
//      env,
//      version).shaped[AMHAssignmentRuleEntityTupleType]
//
//    private val toAssignmentRuleRow: (AMHAssignmentRuleEntityTupleType => AMHAssignmentRuleEntity) = { assignmentTuple => {
//      AMHAssignmentRuleEntity(assignmentTuple._1, assignmentTuple._2, assignmentTuple._3, assignmentTuple._4, assignmentTuple._5, assignmentTuple._6, assignmentTuple._7)
//    }
//    }
//
//    private val toAssignmentRuleTuple: (AMHAssignmentRuleEntity => Option[AMHAssignmentRuleEntityTupleType]) = { assignmentRuleRow =>
//      Some((assignmentRuleRow.code, assignmentRuleRow.sequence, assignmentRuleRow.ruleCode, assignmentRuleRow.dataOwner, assignmentRuleRow.lockCode, assignmentRuleRow.environment, assignmentRuleRow.version))
//    }
//
//    def * = amhAssignmentRuleShapedValue <>(toAssignmentRuleRow, toAssignmentRuleTuple)
//
//  }
//
//  val amhAssignmentRules = TableQuery[AMHBackupAssignmentRules]
//
//}
//
//object BackupAssignmentRuleDAO extends BackupAssignmentRuleDAO {
//  def apply(driver: JdbcProfile) = BackupAssignmentRuleDAO
//}