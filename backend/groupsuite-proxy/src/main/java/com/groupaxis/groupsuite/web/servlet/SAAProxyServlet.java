package com.groupaxis.groupsuite.web.servlet;
 ...
 */
@WebServlet(name="/saa-proxy", urlPatterns= {"/saa/*"})
public class SAAProxyServlet extends HttpServlet {
...
//    protected static final String P_TARGET_URI = "targetUri";
    private  static final String ATTR_TARGET_URI = AMHProxyServlet.class.getSimpleName() + ".targetUri";
    private  static final String ATTR_TARGET_HOST = AMHProxyServlet.class.getSimpleName() + ".targetHost";
  ...
  /* MISC */
    ...
    private final static String SAA_TARGET_URI = "saa.target.uri";
    private final static String PROXY_CONFIG_FILE = "proxy.config.file";
    ...
    private Optional<Properties> loadConfig() throws ServletException {
        Properties config = new Properties();
        InputStream input = null;
        try {
            String configPath = System.getProperty(PROXY_CONFIG_FILE);
    ...
    public void init() throws ServletException {
        config = loadConfig().orElse(new Properties());
...
//        proxyClient = createHttpClient(hcParams);
        proxyClient = HttpClientBuilder.create().evictIdleConnections(1, TimeUnit.SECONDS).build();
    }
...
//            throw new ServletException(P_TARGET_URI+" is required.");
        ...
        URI targetUriObj;
        try {
            targetUriObj = new URI(config.getProperty(SAA_TARGET_URI));
        } catch (Exception e) {
            throw new ServletException("Trying to process targetUri init parameter: "+e,e);
        }
...
//            Class clientClazz = Class.forName("org.apache.http.impl.client.SystemDefaultHttpClient");
            Class clientClazz = Class.forName("org.apache.http.impl.client.HttpClientBuilder");
...
//    }
    ...
    protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
        ...
        if (servletRequest.getAttribute(ATTR_TARGET_URI) == null) {
            servletRequest.setAttribute(ATTR_TARGET_URI, config.getProperty(SAA_TARGET_URI));
        }
    ...
    private HttpRequest newProxyRequestWithEntity(String method, String proxyRequestUri,
        ...
        //new FileEntity(new File(servletRequest.getInputStream()))
...
//        boolean doSendUrlFragment = true;
    ...
    private String rewriteQueryStringFromRequest(String queryString) {
        return queryString;
    }
