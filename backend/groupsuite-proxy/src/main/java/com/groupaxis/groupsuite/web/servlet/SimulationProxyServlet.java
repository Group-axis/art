 ...
 */
@WebServlet(name="/simulation-proxy", urlPatterns= {"/simulation/*"})
public class SimulationProxyServlet extends HttpServlet {
...
//    protected static final String P_TARGET_URI = "targetUri";
  ...
  /* MISC */
    ...
    private final static String SIMULATION_TARGET_URI = "simulation.target.uri";
...
//            throw new ServletException(P_TARGET_URI+" is required.");
        ...
        URI targetUriObj;
        try {
            targetUriObj = new URI(config.getProperty(SIMULATION_TARGET_URI));
        } catch (Exception e) {
            throw new ServletException("Trying to process targetUri init parameter: "+e,e);
        }
...
//    }
    ...
    protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
        ...
        if (servletRequest.getAttribute(ATTR_TARGET_URI) == null) {
            servletRequest.setAttribute(ATTR_TARGET_URI, config.getProperty(SIMULATION_TARGET_URI));
        }
