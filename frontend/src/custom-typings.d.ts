...
declare var BACKEND_HOST_PORT: string;
declare var BACKEND_ES_HOST_PORT: string;
declare var SECURE_PROTOCOL : string;
declare var UNSECURE_PROTOCOL : string;
declare var HOST : string;
interface GlobalEnvironment {
  ENV;
  HMR;
  BACKEND_HOST_PORT;
  BACKEND_ES_HOST_PORT;
  SECURE_PROTOCOL;
  UNSECURE_PROTOCOL;
  HOST;
}
